...
namespace Artemis.UI.Screens.Profiles.ProfileEditor.StatusBar;
...
public partial class StatusBarViewModel : ActivatableViewModelBase
{
    ...
    public StatusBarViewModel(IProfileEditorService profileEditorService)
    {
        ...
        this.WhenAnyValue<StatusBarViewModel, bool>(vm => vm.ShowStatusMessage).Where(v => v).Throttle(TimeSpan.FromSeconds(3)).Subscribe(_ => ShowStatusMessage = false);
    }
