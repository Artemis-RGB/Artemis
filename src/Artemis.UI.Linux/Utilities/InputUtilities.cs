...
namespace Artemis.UI.Linux.Utilities
{
    ...
    {
        public static KeyboardKey KeyFromKeyCode(LinuxKeyboardKeyCodes code) => code switch
            {
        ...
        public static MouseButton MouseButtonFromButtonCode(LinuxKeyboardKeyCodes eCode) => eCode switch
            {
